...
if(isset($_POST['barangmasuk'])){
    ...
    $updatestockmasuk = mysqli_query($conn,"update stok set stok = '$tambahkanstoksekarangdenganquantity' where idbarang= '$barangnya'");
...
if(isset($_POST['updatebarangmasuk'])){
    ...
    if($qty>$qtyskrng){
        ...
        $kurangstoknya = mysqli_query($conn,"update stok set stok='$kurangin' where idbarang='$idb'");
